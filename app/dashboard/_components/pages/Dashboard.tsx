...
import { Plus, Bell, Sparkles, Plane } from "lucide-react";
import Link from "next/link";

const Dashboard = () => {
  const [createTripBoxOpen, setCreateTripBoxOpen] = useState(false);
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="mx-auto w-full max-w-8xl px-3 py-4 sm:px-5 sm:py-6 lg:px-8">
        ...
        <div className="mb-6  p-4  sm:p-6">
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              {/* Add Trip Button */}
              <Button
                onClick={() => setCreateTripBoxOpen(true)}
        ...
        {/* Trips Section */}
        <div className="">
          <Trips setTripBoxOpen={setCreateTripBoxOpen} />
        </div>
      </div>

      {/* Create Trip Modal */}
      {createTripBoxOpen && <CreateTrip cancel={setCreateTripBoxOpen} />}
    </div>
  );
};
